...
module top(
	...
	(* MARK_DEBUG="true" *)input                       cmos1_vsync,        //cmos vsync
	...
	(* MARK_DEBUG="true" *)input                       cmos2_vsync,        //cmos vsync
...
(* MARK_DEBUG="true" *)wire[BUSRT_BITS - 1:0]          rd_burst_len;
(* MARK_DEBUG="true" *)wire[BUSRT_BITS - 1:0]          wr_burst_len;
(* MARK_DEBUG="true" *)wire[ADDR_BITS - 1:0]           rd_burst_addr;
(* MARK_DEBUG="true" *)wire[ADDR_BITS - 1:0]           wr_burst_addr;
(* MARK_DEBUG="true" *)wire                            rd_burst_data_valid;
(* MARK_DEBUG="true" *)wire[MEM_DATA_BITS - 1 : 0]     rd_burst_data;
(* MARK_DEBUG="true" *)wire[MEM_DATA_BITS - 1 : 0]     wr_burst_data;

(* MARK_DEBUG="true" *)wire                            read_req;
(* MARK_DEBUG="true" *)wire                            read_req_ack;
...
(* MARK_DEBUG="true" *)wire                            write_req_ack;
...
assign hdmi_out_data   = {vout_data[4:0],3'd0,vout_data[10:5],2'd0,vout_data[15:11],3'd0};
...
wire tx0_clk;
(* MARK_DEBUG="true" *)wire gt0_txfsmresetdone;
...
(* MARK_DEBUG="true" *)wire[31:0] gt_tx_data0;
(* MARK_DEBUG="true" *)wire[3:0] gt_tx_ctrl0;
(* MARK_DEBUG="true" *)wire[31:0] gt_tx_data1;
(* MARK_DEBUG="true" *)wire[3:0] gt_tx_ctrl1;
...
(* MARK_DEBUG="true" *)wire[15:0] cmos1_d_16bit;
(* MARK_DEBUG="true" *)wire cmos1_href_16bit;
reg[7:0] cmos1_d_d0;
reg cmos1_href_d0;
...
(* MARK_DEBUG="true" *)wire[15:0] cmos2_d_16bit;
(* MARK_DEBUG="true" *)wire cmos2_href_16bit;
reg[7:0] cmos2_d_d0;
reg cmos2_href_d0;
