...
#=================================================================================
  ...
  set_property -dict [ list \
   ...
   CONFIG.HAS_TKEEP {1} \
   CONFIG.HAS_TLAST {1} \
 ] [get_bd_intf_pins /axi_i2s_adi_0/m_axis]
  ...
  set_property -dict [ list \
   ...
   CONFIG.HAS_TREADY {1} \
   CONFIG.HAS_TLAST {1} \
 ] [get_bd_intf_pins /axi_i2s_adi_0/s_axis]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_GPIO_0 [get_bd_intf_pins processing_system7_0/GPIO_0] [get_bd_intf_ports GPIO]
  connect_bd_intf_net -intf_net processing_system7_0_IIC_0 [get_bd_intf_pins processing_system7_0/IIC_0] [get_bd_intf_ports wm8731_i2c]
  ...
  connect_bd_net -net axi_i2s_adi_0_lrclk_o [get_bd_pins axi_i2s_adi_0/lrclk_o] [get_bd_ports wm8731_adclrc] [get_bd_ports wm8731_daclrc]
  connect_bd_net -net axi_i2s_adi_0_sdata_o [get_bd_pins axi_i2s_adi_0/sdata_o] [get_bd_ports wm8731_dacdat]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins axi_i2s_adi_0/s_axis_aclk] [get_bd_pins axi_i2s_adi_0/m_axis_aclk] [get_bd_pins axi_i2s_adi_0/s_axi_aclk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
