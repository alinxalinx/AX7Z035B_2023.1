...
\
  ...
  set_property CONFIG.NUM_SI {2} $axi_smc1


  # Create interface connections
  connect_bd_intf_net -intf_net alinx_ov5640_1_m_axis_video [get_bd_intf_pins alinx_ov5640_1/m_axis_video] [get_bd_intf_pins axis_subset_converter_0/S_AXIS]
  connect_bd_intf_net -intf_net axi_smc1_M00_AXI [get_bd_intf_pins axi_smc1/M00_AXI] [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
  ...
  connect_bd_intf_net -intf_net mem2stream_0_m_axi_gmem [get_bd_intf_pins mem2stream_0/m_axi_gmem] [get_bd_intf_pins axi_smc1/S01_AXI]
  ...
  connect_bd_intf_net -intf_net stream2mem_0_m_axi_gmem [get_bd_intf_pins axi_smc1/S00_AXI] [get_bd_intf_pins stream2mem_0/m_axi_gmem]
  ...
  connect_bd_net -net cmos1_d_1 [get_bd_ports cmos1_d] [get_bd_pins alinx_ov5640_1/cmos_d]
  connect_bd_net -net cmos1_href_1 [get_bd_ports cmos1_href] [get_bd_pins alinx_ov5640_1/cmos_href]
  connect_bd_net -net cmos1_pclk_1 [get_bd_ports cmos1_pclk] [get_bd_pins alinx_ov5640_1/cmos_pclk]
  connect_bd_net -net cmos1_vsync_1 [get_bd_ports cmos1_vsync] [get_bd_pins alinx_ov5640_1/cmos_vsync]
  connect_bd_net -net mem2stream_0_indexr [get_bd_pins mem2stream_0/indexr] [get_bd_pins stream2mem_0/indexr]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins util_ds_buf_0/BUFG_O] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins cmos_rst/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins axi_dynclk_0/REF_CLK_I] [get_bd_pins axi_dynclk_0/s00_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins util_ds_buf_1/BUFG_O] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins rst_ps7_0_150M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins v_tc_0/s_axi_aclk] [get_bd_pins mem2stream_0/ap_clk] [get_bd_pins stream2mem_0/ap_clk] [get_bd_pins alinx_ov5640_1/m_axis_video_aclk] [get_bd_pins axi_smc1/aclk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins cmos_rst/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins axi_dynclk_0/s00_axi_aresetn]
  connect_bd_net -net rst_ps7_0_150M_interconnect_aresetn [get_bd_pins rst_ps7_0_150M/interconnect_aresetn] [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins alinx_ov5640_1/m_axis_video_aresetn]
  connect_bd_net -net rst_ps7_0_150M_peripheral_aresetn [get_bd_pins rst_ps7_0_150M/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tc_0/s_axi_aresetn] [get_bd_pins mem2stream_0/ap_rst_n] [get_bd_pins stream2mem_0/ap_rst_n] [get_bd_pins axi_smc1/aresetn]
